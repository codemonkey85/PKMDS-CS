...
{
    private static readonly List<MovesObject> _moveList = new();
    private static readonly List<SpeciesObject> _speciesList = new();
    private static readonly List<ItemObject> _itemList = new();
    private static readonly List<AbilityObject> _abilityList = new();
    private static readonly List<LocationObject> _locationList = new();
...
public class MovesObject
{
    ...
    public static implicit operator MovesObject(Moves move) => new(move);
    ...
    public Image CategoryImage
    {
        get
        {
            ...
            return damageclassid switch
            {
                1 => Images.GetImageFromResource("physical"),
                2 => Images.GetImageFromResource("special"),
                0 => Images.GetImageFromResource("other"),
                _ => null,
            };
        }
    }

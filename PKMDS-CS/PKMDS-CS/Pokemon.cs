...
namespace PKMDS_CS
{
    ...
    public class Pokemon : IEquatable<Pokemon>, IComparable<Pokemon>
    {
        ...
        public static bool operator ==(Pokemon a, Pokemon b) => ReferenceEquals(a, b) || !(a is null) && !(b is null) && a.data.SequenceEqual(b.data);

        public static bool operator !=(Pokemon a, Pokemon b) => !(a == b);

        public bool Equals(Species other) => Species == other;

        public static bool operator ==(Pokemon a, Species b) => !(a is null) && a.Species == b;

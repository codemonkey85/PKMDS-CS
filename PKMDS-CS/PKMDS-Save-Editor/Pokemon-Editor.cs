...
public partial class Pokemon_Editor_Form : Form
{
    ...
    */
    ...
    private readonly Pokemon tempPokemon = new();
    ...
    private readonly BindingSource _pokemonBindingSource = new();
    private readonly BindingSource _itemBindingSource = new();
    private readonly BindingSource _moveBindingSource = new();
    private readonly BindingSource _relearnableMoveBindingSource = new();
    ...
    private readonly List<PictureBox> MarkingsBoxes = new();

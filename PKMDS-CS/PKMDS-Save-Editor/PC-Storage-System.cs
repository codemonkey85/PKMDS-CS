...
public partial class PC_Storage_System_Form : Form
{
    ...
    private readonly BindingSource _boxesBindingSource = new();
    private readonly BindingSource _pokemonBindingSource = new();
    private CurrencyManager _boxesCurrencyManager;
    private readonly BindingSource _boxenamesBindingSource = new();
    ...
    private readonly List<PictureBox> pbSlots = new();
    ...
    {
        if (dgPokemon.DataSource is not Pokemon[] pokemons)
        {
            return;
        }
